...
-- -----------------------------------------------------
-- Data for table `exerciseLog`
-- -----------------------------------------------------
START TRANSACTION;
USE `exercisedb`;
INSERT INTO `exerciseLog` (`id`, `type`, `date`, `start_time`, `end_time`, `latitude`, `longitude`, `calories_burned`, `distance`, `average_pace`, `elevation_gain`) VALUES (1, 'hiking', '2020-01-04', '11:16:00', '13:37:45', 39.716551, -105.209797, 576, 5.00, '28:21', 1106);
